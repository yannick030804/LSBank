...
# 10 "TAD_Controller.c" 2
# 1 "./TAD_Controller.h" 1
# 24 "./TAD_Controller.h"
void Controller_Init (void);

void motorController (void);
# 11 "TAD_Controller.c" 2
# 1 "./TAD_SIO.h" 1
        ...
        case 11:
            if (SIO_TxAvail()) {
                if (uid_ptr[i] != '\0') {
                    ...
                    speaker_sound(0, 10000);
                    i = 0;
                    state = 12;
                    uid_ptr = "> LSBank - Reset System: ";
                }
            }
            break;
        case 12:
